// 0.28.20 More Function Review
// Due October 31, 2020 9:00 AM
// Instructions
// Problem 1
...
// }
// console.log(initials(name.charAt(0), name.charAt(5)))//=> eddy duroseau e d
// Problem 2
...
//   let health = 'a daily ritual to advance'
//  function replaceA(sweat){
   
 
//      return sweat.replace(/a/g, '-')
//  }
//  console.log(replaceA(health))=> - d-ily ritu-l to -dv-nce
...
//     return index
// }
// console.log(characterAt(health[5]))//=> l
...
// let money = 'the root of all evil'
// function theLength(moolah){
//     return moolah.length
// }
// console.log(theLength(money))//=> 20
...
// let life = 'what you make it'
// function lastchar(enjoy){
//     return enjoy[enjoy.length -1]
// }
// console.log(lastchar(life))//=> t
...
// function lastTwoEle(ihop){
    
//     return  breakfast.slice(3,5)
// }
//  console.log(lastTwoEle(breakfast))//=> 'pancake', 'oatmeal'
...
//     return breakfast.slice(1)
// }
// console.log(removeFirst(breakfast))//=> 'eggs', 'juice', 'pancake', 'oatmeal'

This took a little brainwork, I hope I got at least 2 right.
