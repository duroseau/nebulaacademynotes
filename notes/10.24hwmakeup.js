...
function lastElement(world){
    console.log(countries[5])
    return 'the last element in the array is ' + world[5]
}
...
let myPlace = ['Haiti', 'Mexico', 'Canada', 'Italy', 'United Kingdom', 'Thailand', 'India']
function favoriteCountry(hispaniola){
console.log(myPlace[0])
return `My favorite country is ${hispaniola[0]}`
}
console.log(favoriteCountry(myPlace))


Manami: this is a continuation, I will put it all together if you wish.
